...
public interface ParamInfoRepository extends JpaRepository<IamMsParameterInfo, Long> {
	...
	Optional<IamMsParameterInfo> findByParamCodeAndIsDeleted(String paramInfo, String isDeleted);

	boolean existsByParamCodeAndIsDeleted(String paramInfo, String isDeleted);
